...
import Servicios.AcademicServicesI;

import java.util.ArrayList;
import java.util.List;
import java.util.HashMap;

public abstract class AcademicManager implements AcademicServicesI {

    private List<Student> students;
    private List<Student> courses;
    private HashMap<Course, List<Student>> studentsByCourse;
